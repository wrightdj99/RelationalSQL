...
--HOMEWORK TRUE BEGINNING

--Question 1
Select DISTINCT employee.fname, employee.lname, works_on.essn
from employee
join works_on on works_on.Essn = employee.ssn
where employee.ssn = works_on.essn
order by works_on.essn;

--Question 2
Select DISTINCT employee.dno, department.dname
...
From Employee
Where employee.dno = (select dno from employee where employee.salary = (Select min(employee.salary) From employee))
